#ifndef _COMM_MACROS_
#define _COMM_MACROS_
...
/* Private defines -----------------------------------------------------------*/
#define LED_SYSTCK_ISR_Pin GPIO_PIN_15
#define LED_SYSTCK_ISR_GPIO_Port GPIOC
#define tempAutoLED_Pin GPIO_PIN_2
#define tempAutoLED_GPIO_Port GPIOA
#define tempDecreaseLED_Pin GPIO_PIN_3
#define tempDecreaseLED_GPIO_Port GPIOA
...
#define tempIncreaseLED_Pin GPIO_PIN_5
#define tempIncreaseLED_GPIO_Port GPIOB
