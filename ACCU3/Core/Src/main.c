...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, Red_2_LED_Pin|Red_1_LED_Pin|Relay_2_Pin|LCD_EN_Pin
  ...
  /*Configure GPIO pins : Red_2_LED_Pin Red_1_LED_Pin Relay_2_Pin LCD_EN_Pin
                           LCD_RS_Pin */
  GPIO_InitStruct.Pin = Red_2_LED_Pin|Red_1_LED_Pin|Relay_2_Pin|LCD_EN_Pin
                          |LCD_RS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
